...
class FromGymEnv(FromGymnasiumEnv):
    pass
...
class FromDmEnv(Environment):
    ...
    def action_space(self) -> Space:
        ...
        self._action_space = Space.from_dm_env(self._env.action_space)
        return self._action_space
    ...
    def observation_space(self) -> Space:
        ...
        self._observation_space = Space.from_dm_env(self._env.observation_space)
        return self._observation_space
    ...
    def reward_space(self) -> Space:
        ...
        self._reward_space = Space.from_dm_env(self._env.reward_range)
        return self._reward_space
    ...
    def reset(self, seed: int | None = None) -> Timestep:
        next_step = self._env.reset(seed)
        self._current_observation = jnp.asarray(next_step[0])
